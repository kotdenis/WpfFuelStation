...
{
  public class OutComeCheck : Report
  {
    ...
    private void InitializeComponent()
    {
      string reportString = 
        ...
        "nfo.Created=\"01/02/2021 17:02:26\" ReportInfo.Modified=\"01/10/2021 23:22:29\" Repo" +
        ...
        "Oo40Z2NnP2fBJJqQ0YhkCEvhWqTIS3o04MH4IVsFdrutInnexUdUlWF4bUjJ0CHUX3fDGyZ5fv8BGozl" +
        "X8uaa0K85r48o4w==\" ConnectionStringExpression=\"[ConnectString]\">\r\n      <TableDa" +
        "taSource Name=\"Table\" DataType=\"System.Int32\" Enabled=\"true\" SelectCommand=\"use " +
        "[FuelStationDb]&#13;&#10;&#13;&#10;&#13;&#10;if OBJECT_ID('dbo.ResultTable', 'U'" +
        ") is not null &#13;&#10;drop table dbo.ResultTable &#13;&#10;&#13;&#10;&#13;&#10" +
        ";ALTER DATABASE FuelStationDb SET RECOVERY BULK_LOGGED &#13;&#10;&#13;&#10;&#13;" +
        "&#10;declare @start datetime = @StartDate &#13;&#10;declare @end datetime = @End" +
        "Date&#13;&#10;declare @fuelId int = @IdFuel&#13;&#10;&#13;&#10;select fuel.FuelM" +
        "ark as fuelMark,&#13;&#10;(fuel.MaxFuelValue - tank.Quantity) as quant, &#13;&#1";
      reportString += "0;tank.Quantity - lead(tank.Quantity) over(order by tank.Id) as remains,&#13;&#1" +
        "0;lead(tank.CerrentDate) over(order by tank.Id) as currentData&#13;&#10;into dbo" +
        ".ResultTable&#13;&#10;from dbo.FuelInTank as tank&#13;&#10;join dbo.Fuel as fuel" +
        " on fuel.Id = tank.FuelId &#13;&#10;where fuel.Id = @fuelId and tank.CerrentDate" +
        " &gt;= @start and &#13;&#10;tank.CerrentDate &lt;= @end &#13;&#10;&#13;&#10;sele" +
        "ct res.fuelMark as FuelMark, res.remains as Remains, &#13;&#10;res.currentData a" +
        "s CurrentData&#13;&#10;from dbo.ResultTable as res &#13;&#10;where res.remains &" +
        "gt; 0\">\r\n        <Column Name=\"FuelMark\" DataType=\"System.String\"/>\r\n        <Co" +
        "lumn Name=\"Remains\" DataType=\"System.Single\"/>\r\n        <Column Name=\"CurrentDat" +
        "a\" DataType=\"System.DateTime\"/>\r\n        <CommandParameter Name=\"StartDate\" Data" +
        "Type=\"22\" Size=\"20\"/>\r\n        <CommandParameter Name=\"EndDate\" DataType=\"22\" Si" +
        "ze=\"20\"/>\r\n        <CommandParameter Name=\"IdFuel\" DataType=\"22\" Size=\"10\"/>\r\n  " +
        "    </TableDataSource>\r\n    </MsSqlDataConnection>\r\n    <Parameter Name=\"DateSta";
      reportString += "rt\" DataType=\"System.DateTime\"/>\r\n    <Parameter Name=\"DateEnd\" DataType=\"System" +
        ".DateTime\"/>\r\n    <Parameter Name=\"ConnectString\" DataType=\"System.String\"/>\r\n  " +
        "  <Total Name=\"Total\" Expression=\"[Table.Remains]\" Evaluator=\"Data1\"/>\r\n  </Dict" +
        "ionary>\r\n  <ReportPage Name=\"Page1\">\r\n    <ReportTitleBand Name=\"ReportTitle1\" W" +
        "idth=\"718.2\" Height=\"37.8\">\r\n      <TextObject Name=\"Text1\" Left=\"245.7\" Top=\"18" +
        ".9\" Width=\"151.2\" Height=\"18.9\" Text=\"Расход топлива.\" Font=\"Arial, 12pt, style=" +
        "Bold\"/>\r\n    </ReportTitleBand>\r\n    <PageHeaderBand Name=\"PageHeader1\" Top=\"41." +
        "8\" Width=\"718.2\" Height=\"28.35\">\r\n      <TextObject Name=\"Text2\" Left=\"18.9\" Top" +
        "=\"9.45\" Width=\"132.3\" Height=\"18.9\" Text=\"Отчет за период с\"/>\r\n      <TextObjec" +
        "t Name=\"Text3\" Left=\"151.2\" Top=\"9.45\" Width=\"113.4\" Height=\"18.9\" Text=\"[DateSt" +
        "art]\" Format=\"Date\" Format.Format=\"d\"/>\r\n      <TextObject Name=\"Text4\" Left=\"26" +
        "4.6\" Top=\"9.45\" Width=\"28.35\" Height=\"18.9\" Text=\"по\"/>\r\n      <TextObject Name=";
      reportString += "\"Text5\" Left=\"292.95\" Top=\"9.45\" Width=\"113.4\" Height=\"18.9\" Text=\"[DateEnd]\" Fo" +
        "rmat=\"Date\" Format.Format=\"d\"/>\r\n    </PageHeaderBand>\r\n    <ColumnHeaderBand Na" +
        "me=\"ColumnHeader1\" Top=\"74.15\" Width=\"718.2\" Height=\"37.8\">\r\n      <TableObject " +
        "Name=\"Table1\" Left=\"18.9\" Top=\"18.9\" Width=\"377.89\" Height=\"18.9\">\r\n        <Tab" +
        "leColumn Name=\"Column13\" Width=\"54.31\"/>\r\n        <TableColumn Name=\"Column14\" W" +
        "idth=\"92.11\"/>\r\n        <TableColumn Name=\"Column15\" Width=\"129.91\"/>\r\n        <" +
        "TableColumn Name=\"Column16\" Width=\"101.56\"/>\r\n        <TableRow Name=\"Row5\">\r\n  " +
        "        <TableCell Name=\"Cell18\" Border.Lines=\"All\" Border.Width=\"2\" Text=\"№\" Ho" +
        "rzAlign=\"Center\" Font=\"Arial, 9.75pt, style=Bold\"/>\r\n          <TableCell Name=\"" +
        "Cell19\" Border.Lines=\"All\" Border.Width=\"2\" Text=\"Марка топлива\" HorzAlign=\"Cent" +
        "er\" Font=\"Arial, 9.75pt, style=Bold\"/>\r\n          <TableCell Name=\"Cell20\" Borde" +
        "r.Lines=\"All\" Border.Width=\"2\" Text=\"Дата расхода\" HorzAlign=\"Center\" Font=\"Aria";
      reportString += "l, 9.75pt, style=Bold\"/>\r\n          <TableCell Name=\"Cell21\" Border.Lines=\"All\" " +
        "Border.Width=\"2\" Text=\"Объем\" HorzAlign=\"Center\" Font=\"Arial, 9.75pt, style=Bold" +
        "\"/>\r\n        </TableRow>\r\n      </TableObject>\r\n    </ColumnHeaderBand>\r\n    <Da" +
        "taBand Name=\"Data1\" Top=\"115.95\" Width=\"718.2\" Height=\"28.35\" DataSource=\"Table\"" +
        ">\r\n      <TableObject Name=\"Table1\" Left=\"18.9\" Width=\"377.85\" Height=\"28.35\" Bo" +
        "rder.Lines=\"All\">\r\n        <TableColumn Name=\"Column9\" Width=\"54.3\"/>\r\n        <" +
        "TableColumn Name=\"Column10\" Width=\"92.1\"/>\r\n        <TableColumn Name=\"Column11\"" +
        " Width=\"129.9\"/>\r\n        <TableColumn Name=\"Column12\" Width=\"101.55\"/>\r\n       " +
        " <TableRow Name=\"Row4\" Height=\"28.35\">\r\n          <TableCell Name=\"Cell14\" Borde" +
        "r.Lines=\"All\" Text=\"[Row#]\" HorzAlign=\"Center\"/>\r\n          <TableCell Name=\"Cel" +
        "l15\" Border.Lines=\"All\" Text=\"[Table.FuelMark]\" HorzAlign=\"Center\"/>\r\n          " +
        "<TableCell Name=\"Cell16\" Border.Lines=\"All\" Text=\"[Table.CurrentData]\" Format=\"D";
      reportString += "ate\" Format.Format=\"d\" HorzAlign=\"Center\"/>\r\n          <TableCell Name=\"Cell17\" " +
        "Border.Lines=\"All\" Text=\"[Table.Remains]\" HorzAlign=\"Center\"/>\r\n        </TableR" +
        "ow>\r\n      </TableObject>\r\n    </DataBand>\r\n    <ReportSummaryBand Name=\"ReportS" +
        "ummary1\" Top=\"148.3\" Width=\"718.2\" Height=\"37.8\">\r\n      <TextObject Name=\"Text6" +
        "\" Left=\"292.95\" Width=\"103.95\" Height=\"18.9\" Text=\"[Total]\" HorzAlign=\"Center\" F" +
        "ont=\"Arial, 9.75pt, style=Bold\"/>\r\n      <TextObject Name=\"Text7\" Left=\"198.45\" " +
        "Width=\"94.5\" Height=\"18.9\" Text=\"Итого:\" HorzAlign=\"Center\" Font=\"Arial, 9.75pt," +
        " style=Bold\"/>\r\n    </ReportSummaryBand>\r\n    <PageFooterBand Name=\"PageFooter1\"" +
        " Top=\"190.1\" Width=\"718.2\" Height=\"47.25\"/>\r\n  </ReportPage>\r\n</Report>\r\n";
